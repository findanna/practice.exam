...
fusen::fill_description(
  ...
  fields = list(
    ...
    Description = "Package for practicing exam for package creation.",
    `Authors@R` = c(
      person("Anna", "Mantsoki", email = "anna.mantsoki@finddx.org", role = c("aut", "cre"), comment = c(ORCID = "")),
      person(given = "FIND", role = "cph")
    )
  ))
# Define License with use_*_license()
usethis::use_mit_license("Anna Mantsoki")
```
